...
const DEFAULT_META_DATA = {
    ...
    "og:locale":'default og:locale',
    "og:type":'default og:type',
    "og:title":'default og:title',
    "og:description":'Default sample meta description Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.',
    "og:url":'default og:url',
    "og:site_name":'default og:site_name',
    "og:image":'https://www.tibs.org.tw/images/default.jpg',
    "og:image:width":'default og:image:width',
    "og:image:height":'default og:image:height',
    "og:image:alt":'default og:image:alt',
...
module.exports = { DEFAULT_META_DATA, META_DATA };